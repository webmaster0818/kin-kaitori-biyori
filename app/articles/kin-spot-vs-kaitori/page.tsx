...
<details className="border-b border-warm-border py-4 group not-prose">
  ...
  <p className="mt-3 text-sm leading-relaxed">歴史的には経済不安時・インフレ局面で金価格が上昇。直近は2024〜2026年で歴史的高値圏。</p>
          ...
          <RelatedArticles
            currentSlug="kin-spot-vs-kaitori"
            relatedSlugs={["k24-kaitori", "kinseido-kaitori-guide", "k22-kaitori", "daikichi-vs-nanboya", "ikkatsu-satei-hikaku", "tentou-vs-takuhai", "line-satei-seido", "kin-jundo-mikata", "kin-nisemono-mikata", "kin-omosa-hakarikata", "platinum-kaitori", "diamond-kaitori", "kin-takaku-uru", "kin-kaitori-souba", "kaitori-houhou-hikaku", "kin-bracelet-kaitori"]}
          />
        </article>
      </div>
    </>
