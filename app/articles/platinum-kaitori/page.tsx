...
function BreadcrumbSchema() {
  const breadcrumbData = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "プラチナ買取ガイド", item: "https://gold-biyori.com/articles/platinum-kaitori/" },
    ],
  };
  return (
    <script
...
function ArticleSchema() {
  const articleData = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "【2026年最新】プラチナ買取相場ガイド — Pt900/Pt950/Pt1000の価格と高く売る方法",
    description: "プラチナ（Pt1000/Pt950/Pt900/Pt850）の最新買取相場を純度別に掲載。2026年のプラチナ価格高騰の背景、製品別（指輪・ネックレス・時計）の買取価格目安、金との違い・見分け方、おすすめ買取業者4社比較を徹底解説。",
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <RelatedArticles
            ...
            relatedSlugs={["k24-kaitori", "kinseido-kaitori-guide", "k22-kaitori", "daikichi-vs-nanboya", "ikkatsu-satei-hikaku", "tentou-vs-takuhai", "line-satei-seido", "kin-spot-vs-kaitori", "kin-jundo-mikata", "kin-nisemono-mikata", "kin-omosa-hakarikata", "diamond-kaitori", "kin-takaku-uru", "kin-kaitori-souba", "kaitori-houhou-hikaku"]}
          />
