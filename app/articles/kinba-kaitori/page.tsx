...
function BreadcrumbSchema() {
  const breadcrumbData = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "金歯買取ガイド", item: "https://gold-biyori.com/articles/kinba-kaitori/" },
    ],
  };
  return (
    <script
...
function ArticleSchema() {
  const articleData = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "【2026年最新】金歯の買取相場ガイド — 1本いくら？売り方と注意点",
    description: "金歯は買取業者に売れます。金歯1本あたりの買取相場（約3,000〜15,000円）、金歯の純度（K14〜K20）、売り方の手順、衛生面の注意点、金歯買取OKのおすすめ業者4社を徹底解説。",
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="not-prose my-8">
          ...
          <RelatedArticles
            ...
            relatedSlugs={["k24-kaitori", "kinseido-kaitori-guide", "k22-kaitori", "kin-jundo-mikata", "kowareta-kin-kaitori", "kin-takaku-uru", "kin-kaitori-souba", "kaitori-houhou-hikaku", "tokyo-kin-kaitori", "osaka-kin-kaitori", "cartier-kaitori", "kin-necklace-kaitori", "kin-bracelet-kaitori"]}
          />
