...
function BreadcrumbSchema() {
  const breadcrumbData = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "ヴァンクリーフ&アーペル買取ガイド", item: "https://gold-biyori.com/articles/vancleef-kaitori/" },
    ],
  };
  return (
    <script
  ...
  return (
    ...
    <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
      ...
      <div className="article-hero mb-8">
        ...
        <p>2026年4月時点の調査では、金相場の高騰と定価改定の効果により、ヴァンクリーフの買取相場は上昇傾向です。ヴィンテージアルハンブラ20モチーフネックレスは約170万〜220万円、5モチーフブレスレットは約55万〜75万円の高額買取が期待できます。</p>
