...
function BreadcrumbSchema() {
  const d = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "スタージュエリーの金・ジュエリー買取ガイド", item: "https://gold-biyori.com/articles/starjewelry-kaitori/" },
  ] };
  return <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(d) }} />;
}
function ArticleSchema() {
  const d = { "@context": "https://schema.org", "@type": "Article",
    headline: "スタージュエリーの金・ジュエリー買取ガイド", description: "スタージュエリーのジュエリーを高く売るコツ。K10・K18・Ptの素材価値とブランド価値、相場の調べ方を解説します。",
...
function FaqSchema() {
  const d = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "スタージュエリーのネックレスは売れますか？", acceptedAnswer: { "@type": "Answer", text: "はい。K10・K18・Pt製品は素材として評価され買取対象です。" } },
      { "@type": "Question", name: "ペアリングでも売れますか？", acceptedAnswer: { "@type": "Answer", text: "可能です。状態が良いほど評価されます。" } },
      { "@type": "Question", name: "まとめ売りは得ですか？", acceptedAnswer: { "@type": "Answer", text: "総額が大きくなり交渉しやすくなります。" } }
  ] };
  return <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(d) }} />;
}

export const metadata: Metadata = {
  title: "スタージュエリーの金・ジュエリー買取ガイド",
  description: "スタージュエリーのジュエリーを高く売るコツ。K10・K18・Ptの素材価値とブランド価値、相場の調べ方を解説します。",
};

function CtaBox() {
  return (
    <div className="bg-gold-bg border-2 border-accent/30 rounded-xl p-6 my-8">
      <h3 className="font-bold text-base mb-3 text-center">スタージュエリーの無料査定はこちら</h3>
...
export default function StarjewelryKaitoriPage() {
  return (
    <>
    ...
    <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
      <nav aria-label="パンくずリスト" className="text-xs text-warm-gray mb-6">
        <ol className="flex items-center gap-1">
          ...
          <li className="breadcrumb-sep" />
          <li><span className="text-foreground">スタージュエリーの金・ジュエリー買取ガイド</span></li>
        </ol>
      </nav>
      <div className="article-hero mb-8">
        <Image src="/images/article-hero-area.png" alt="【2026年最新】スタージュエリーの金・ジュエリー買取ガイド" width={1200} height={400} className="w-full h-[200px] object-cover rounded-xl" priority />
        <div className="article-hero-overlay rounded-xl" />
      </div>
      <article className="prose">
        <h1 className="text-2xl md:text-3xl font-bold mb-2 !border-none !pb-0 !mt-0">【2026年最新】スタージュエリーの金・ジュエリー買取ガイド</h1>
        <p className="text-warm-gray text-sm mb-8">最終更新: 2026年6月5日</p>
        <p>スタージュエリーは上質な定番ジュエリーが人気で、K10・K18・プラチナの素材価値が評価されます。</p>
        <h2>ポイント</h2>
        <ul>
          <li>K10・K18・Pt素材は地金相場で評価</li>
          <li>定番デザインは中古需要が安定</li>
        ...
        <div className="space-y-3 not-prose">
          {[
            {
              q: "スタージュエリーのネックレスは売れますか？",
              a: "はい。K10・K18・Pt製品は素材として評価され買取対象です。",
            },
            {
              q: "ペアリングでも売れますか？",
              a: "可能です。状態が良いほど評価されます。",
            },
            {
              q: "まとめ売りは得ですか？",
