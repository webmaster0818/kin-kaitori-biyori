...
function BreadcrumbSchema() {
  const d = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "ウィーン金貨ハーモニーの買取相場ガイド", item: "https://gold-biyori.com/articles/vienna-kinka-kaitori/" },
  ] };
  return <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(d) }} />;
}
function ArticleSchema() {
  const d = { "@context": "https://schema.org", "@type": "Article",
    headline: "ウィーン金貨ハーモニーの買取相場ガイド", description: "オーストリアのウィーン金貨ハーモニーを高く売るコツ。純度99.99%の純金としての評価と相場の調べ方を解説します。",
...
function FaqSchema() {
  const d = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "ウィーン金貨は高く売れますか？", acceptedAnswer: { "@type": "Answer", text: "純度99.99%の純金で、重量×金相場の地金価値が基準です。高値圏の今は有利です。" } },
      { "@type": "Question", name: "複数枚まとめて売れますか？", acceptedAnswer: { "@type": "Answer", text: "はい。総量が多いほど交渉しやすくなります。" } },
      { "@type": "Question", name: "カプセルは外すべきですか？", acceptedAnswer: { "@type": "Answer", text: "傷防止のためカプセルのまま査定に出すのがおすすめです。" } }
  ] };
  return <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(d) }} />;
}
...
function CtaBox() {
  return (
    <div className="bg-gold-bg border-2 border-accent/30 rounded-xl p-6 my-8">
      <h3 className="font-bold text-base mb-3 text-center">ウィーン金貨の無料査定はこちら</h3>
...
export default function ViennaKinkaKaitoriPage() {
  return (
    <>
    ...
    <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
      <nav aria-label="パンくずリスト" className="text-xs text-warm-gray mb-6">
        <ol className="flex items-center gap-1">
          ...
          <li className="breadcrumb-sep" />
          <li><span className="text-foreground">ウィーン金貨ハーモニーの買取相場ガイド</span></li>
        </ol>
      </nav>
      <div className="article-hero mb-8">
        <Image src="/images/article-hero-area.png" alt="【2026年最新】ウィーン金貨ハーモニーの買取相場ガイド" width={1200} height={400} className="w-full h-[200px] object-cover rounded-xl" priority />
        <div className="article-hero-overlay rounded-xl" />
      </div>
      <article className="prose">
        <h1 className="text-2xl md:text-3xl font-bold mb-2 !border-none !pb-0 !mt-0">【2026年最新】ウィーン金貨ハーモニーの買取相場ガイド</h1>
        <p className="text-warm-gray text-sm mb-8">最終更新: 2026年6月5日</p>
        <p>ウィーン金貨ハーモニーはオーストリア造幣局発行の地金型金貨で、純度99.99%の純金として評価されます。</p>
        <h2>ポイント</h2>
        <ul>
          <li>純度99.99%・重量が評価の基準</li>
          <li>金相場に連動し高値が出やすい</li>
          <li>ケース・カプセル保管で状態を保つ</li>
        </ul>
        <CtaBox />
        <h2>よくある質問</h2>
        <div className="space-y-3 not-prose">
          {[
            {
              q: "ウィーン金貨は高く売れますか？",
              a: "純度99.99%の純金で、重量×金相場の地金価値が基準です。高値圏の今は有利です。",
            },
            {
              q: "複数枚まとめて売れますか？",
              a: "はい。総量が多いほど交渉しやすくなります。",
            },
            {
              q: "カプセルは外すべきですか？",
              a: "傷防止のためカプセルのまま査定に出すのがおすすめです。",
            },
          ].map((faq) => (
