  ...
  return (
    ...
    <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
      ...
      <article className="prose">
        ...
        <RelatedArticles currentSlug="kin-kakaku-suii" relatedSlugs={["kin-uridoki-2026", "kin-uridoki-2026", "kin-spot-vs-kaitori", "kin-kaitori-souba", "kin-takaku-uru", "kin-bracelet-kaitori", "ueda-kin-kaitori"]} />
