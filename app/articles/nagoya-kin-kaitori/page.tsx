    ...
    <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
      ...
      <div className="article-hero mb-8">
        ...
        <RelatedArticles
          ...
          relatedSlugs={["osaka-kin-kaitori", "kyoto-kin-kaitori", "tokyo-kin-kaitori", "sendai-kin-kaitori", "k24-kaitori", "kinseido-kaitori-guide", "k22-kaitori", "kin-takaku-uru", "kin-kaitori-souba", "kaitori-houhou-hikaku", "daikichi-vs-nanboya", "kin-kaitori-sagi"]}
        />
