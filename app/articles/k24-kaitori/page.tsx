    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>{priceDateJa}時点、金価格は歴史的な高値圏にあります。国際情勢の不安定化、各国中央銀行の金購入拡大、円安の進行——これらの要因が重なり、<strong>K24の買取目安は1gあたり{k24Price.toLocaleString()}円</strong>（{priceDateJa}時点・毎朝自動更新）に達しています。2020年（約6,600円/g）と比較すると約{Math.round((k24Price / 6600) * 10) / 10}倍の上昇です。</p>
        ...
        <div className="not-prose my-8">
          ...
          <RelatedArticles
            ...
            relatedSlugs={["k22-kaitori", "kinseido-kaitori-guide", "k14-kaitori", "kin-necklace-kaitori", "kin-yubiwa-kaitori", "kin-bracelet-kaitori", "kin-nobebo-kaitori", "kin-takaku-uru", "kin-kaitori-souba", "kaitori-houhou-hikaku", "tokyo-kin-kaitori", "osaka-kin-kaitori"]}
          />
