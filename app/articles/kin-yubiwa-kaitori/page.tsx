...
function BreadcrumbSchema() {
  const breadcrumbData = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "金の指輪買取ガイド", item: "https://gold-biyori.com/articles/kin-yubiwa-kaitori/" },
    ],
  };
  return (
    <script
...
function ArticleSchema() {
  const articleData = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "金の指輪・結婚指輪の買取相場はいくら？今日の価格と高く売るコツ【2026年7月】",
  ...
  return (
    ...
    <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
      ...
      <div className="article-hero mb-8">
        ...
        <h1 className="text-2xl md:text-3xl font-bold mb-2 !border-none !pb-0 !mt-0">金の指輪・結婚指輪の買取相場はいくら？今日の価格と高く売るコツ</h1>
        ...
        <RelatedArticles
          currentSlug="kin-yubiwa-kaitori"
          relatedSlugs={["k24-kaitori", "kinseido-kaitori-guide", "k22-kaitori", "kin-necklace-kaitori", "kin-bracelet-kaitori", "kongyaku-yubiwa-uru", "kin-takaku-uru", "kin-kaitori-souba", "kaitori-houhou-hikaku", "tokyo-kin-kaitori", "osaka-kin-kaitori", "cartier-kaitori"]}
        />
