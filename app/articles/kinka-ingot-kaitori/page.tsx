...
function BreadcrumbSchema() {
  const breadcrumbData = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "金貨・インゴット買取ガイド", item: "https://gold-biyori.com/articles/kinka-ingot-kaitori/" },
    ],
  };
  return (
    <script
...
function ArticleSchema() {
  const articleData = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "【2026年最新】金貨・インゴット買取ガイド — 種類別の相場と税金の注意点",
    description: "金貨（メイプルリーフ・ウィーン・カンガルー・パンダ・天皇陛下記念金貨）とインゴット（田中貴金属・徳力本店・三菱マテリアル）の買取相場を掲載。重量別の買取目安、200万円超の税金対策、おすすめ買取業者4社を徹底解説。",
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <RelatedArticles
            ...
            relatedSlugs={["k24-kaitori", "k18-kaitori", "k22-kaitori", "kin-nobebo-kaitori", "kin-spot-vs-kaitori", "kin-takaku-uru", "kin-kaitori-souba", "kaitori-houhou-hikaku", "tokyo-kin-kaitori", "osaka-kin-kaitori", "cartier-kaitori", "kin-necklace-kaitori"]}
          />
