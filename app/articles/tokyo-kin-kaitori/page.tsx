...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://gold-biyori.com/articles/tokyo-kin-kaitori/" },
};
    ...
    <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
      ...
      <div className="article-hero mb-8">
        ...
        <RelatedArticles
          ...
          relatedSlugs={["ginza-kin-kaitori", "okachimachi-kin-kaitori", "ikebukuro-kin-kaitori", "yokohama-kin-kaitori", "k24-kaitori", "kinseido-kaitori-guide", "k22-kaitori", "kin-takaku-uru", "kin-kaitori-souba", "kaitori-houhou-hikaku", "daikichi-vs-nanboya", "kin-kaitori-sagi"]}
        />
