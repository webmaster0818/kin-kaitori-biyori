...
function BreadcrumbSchema() {
  const d = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "金インゴット500g・1kgの買取ガイド", item: "https://gold-biyori.com/articles/ingot-500g-kaitori/" },
  ] };
  return <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(d) }} />;
}
function ArticleSchema() {
  const d = { "@context": "https://schema.org", "@type": "Article",
    headline: "金インゴット500g・1kgの買取ガイド", description: "金インゴット（500g・1kg）を高く売るコツ。高額地金の安全な売却方法と相場の調べ方を解説します。",
...
function FaqSchema() {
  const d = { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
      { "@type": "Question", name: "1kgのインゴットはいくらになりますか？", acceptedAnswer: { "@type": "Answer", text: "金相場×1000gで、相場により1,500万円規模になることもあります。" } },
      { "@type": "Question", name: "高額売却で税金はかかりますか？", acceptedAnswer: { "@type": "Answer", text: "譲渡所得として申告が必要な場合があります。詳しくは金買取の税金に関する記事をご確認ください。" } },
      { "@type": "Question", name: "安全に売るには？", acceptedAnswer: { "@type": "Answer", text: "店頭での対面取引や、実績のある業者の利用がおすすめです。" } }
  ] };
  return <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(d) }} />;
}

export const metadata: Metadata = {
  title: "金インゴット500g・1kgの買取ガイド",
  description: "金インゴット（500g・1kg）を高く売るコツ。高額地金の安全な売却方法と相場の調べ方を解説します。",
};

function CtaBox() {
  return (
    <div className="bg-gold-bg border-2 border-accent/30 rounded-xl p-6 my-8">
      <h3 className="font-bold text-base mb-3 text-center">インゴット500gの無料査定はこちら</h3>
...
export default function Ingot500gKaitoriPage() {
  return (
    <>
    ...
    <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
      <nav aria-label="パンくずリスト" className="text-xs text-warm-gray mb-6">
        <ol className="flex items-center gap-1">
          ...
          <li className="breadcrumb-sep" />
          <li><span className="text-foreground">金インゴット500g・1kgの買取ガイド</span></li>
        </ol>
      </nav>
      <div className="article-hero mb-8">
        <Image src="/images/article-hero-area.png" alt="【2026年最新】金インゴット500g・1kgの買取ガイド" width={1200} height={400} className="w-full h-[200px] object-cover rounded-xl" priority />
        <div className="article-hero-overlay rounded-xl" />
      </div>
      <article className="prose">
        <h1 className="text-2xl md:text-3xl font-bold mb-2 !border-none !pb-0 !mt-0">【2026年最新】金インゴット500g・1kgの買取ガイド</h1>
        <p className="text-warm-gray text-sm mb-8">最終更新: 2026年6月5日</p>
        <p>500g・1kgの大型インゴットは高額になるため、信頼できる業者選びと安全な取引が特に重要です。</p>
        <h2>ポイント</h2>
        <ul>
          <li>地金価値が数百万円規模になることも</li>
          <li>本人確認（マイナンバー）が必要な場合がある</li>
          <li>高額のため複数業者比較と安全な受け渡しが重要</li>
        </ul>
        <CtaBox />
        <h2>よくある質問</h2>
        <div className="space-y-3 not-prose">
          {[
            {
              q: "1kgのインゴットはいくらになりますか？",
              a: "金相場×1000gで、相場により1,500万円規模になることもあります。",
            },
            {
              q: "高額売却で税金はかかりますか？",
              a: "譲渡所得として申告が必要な場合があります。詳しくは金買取の税金に関する記事をご確認ください。",
            },
            {
              q: "安全に売るには？",
              a: "店頭での対面取引や、実績のある業者の利用がおすすめです。",
            },
          ].map((faq) => (
        ...
        <RelatedArticles currentSlug="ingot-500g-kaitori" relatedSlugs={["ingot-100g-kaitori", "kinka-ingot-kaitori", "kin-kaitori-zeikin", "kin-200man-mynumber", "kin-takaku-uru"]} />
        <DealerComparisonTable heading="インゴット500gの買取で使える主要サービス比較" intro="公式情報をもとに金買取サービスを比較しました。" />
        <h2>まとめ</h2>
