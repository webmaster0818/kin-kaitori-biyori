  ...
  return (
    ...
    <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
      ...
      <article className="prose">
        ...
        <RelatedArticles currentSlug="kin-kaitori-sokujitsu" relatedSlugs={["kin-kaitori-tetsuzuki-guide", "kaitori-houhou-hikaku", "tentou-vs-takuhai", "kin-takaku-uru", "kin-kaitori-souba"]} />
