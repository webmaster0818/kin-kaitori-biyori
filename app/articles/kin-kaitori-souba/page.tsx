...
function BreadcrumbSchema() {
  const breadcrumbData = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "金買取相場", item: "https://gold-biyori.com/articles/kin-kaitori-souba/" },
    ],
  };
  return (
    <script
  ...
  const faqData = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "K24（純金）は金含有率99.99%、K18は75%です。K18の1gあたり買取価格はK24の約75%程度になります。比率の目安として、K18はK24の75%程度の価格になります（最新の実額は本ページの自動更新表をご確認ください）。",
        },
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div className="space-y-3 not-prose">
            {[
              ...
              },
              {
                ...
                a: "K24（純金）は金含有率99.99%、K18は75%です。そのため、K18の1gあたり買取価格はK24の約75%程度になります。比率の目安として、K18はK24の75%程度の価格になります（最新の実額は本ページの自動更新表をご確認ください）。ただし、K18製品にはデザイン性やブランド価値が加味されることがあるため、製品の状態やブランドによってはさらに高値が付くこともあります。",
              },
              {
                q: "金の買取に消費税はかかりますか？",
          ...
          <p>金の買取相場は高値圏で推移しています。最新の1gあたりの目安は、本ページ冒頭の自動更新表をご確認ください。</p>
