  ...
  return (
    ...
    <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
      ...
      <article className="prose">
        ...
        <RelatedArticles currentSlug="pontevecchio-kaitori" relatedSlugs={["cartier-kaitori", "diamond-kaitori", "kinseido-kaitori-guide", "kin-takaku-uru", "kin-necklace-kaitori"]} />
