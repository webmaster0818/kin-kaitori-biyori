...
const articles = [
  ...
  {
    href: "/articles/k22-kaitori/",
    tag: "品目ガイド",
    title: "【2026年最新】K22（22金）買取相場ガイド — 1gあたりの価格と高く売る方法",
    description:
      "K22（22金・純度91.7%）の最新買取相場を1gあたりの価格で掲載。K22金貨・海外ジュエリーの買取価格、刻印の見分け方を解説。",
    tags: ["K22", "22金", "金貨", "海外ジュエリー"],
  },
  {
    href: "/articles/k14-kaitori/",
    tag: "品目ガイド",
    title: "【2026年最新】K14（14金）買取相場ガイド — 1gあたりの価格と高く売る方法",
    description:
      "K14（14金・純度58.5%）の最新買取相場を1gあたりの価格で掲載。585刻印の意味、ハワイアンジュエリーの買取価格を解説。",
    tags: ["K14", "14金", "585", "ハワイアンジュエリー"],
  },
  {
  ...
  {
    href: "/articles/kin-necklace-kaitori/",
    tag: "品目ガイド",
    title: "【2026年最新】金ネックレス買取相場ガイド — 純度・重さ別の価格と高く売るコツ",
    description:
      "金ネックレスの最新買取相場を純度別・重量別に掲載。喜平ネックレスの買取価格、チェーン切れでも売れる理由を解説。",
    tags: ["ネックレス", "喜平", "チェーン", "K18"],
  },
  {
    href: "/articles/kin-yubiwa-kaitori/",
    tag: "品目ガイド",
    title: "【2026年最新】金の指輪（リング）買取相場ガイド — 結婚指輪・ブランドリングの価格",
    description:
      "金の指輪の最新買取相場を素材別に掲載。結婚指輪・婚約指輪・ブランドリングの買取価格目安、宝石付きの査定ポイントを解説。",
    tags: ["指輪", "リング", "結婚指輪", "婚約指輪"],
  },
  {
    href: "/articles/kin-bracelet-kaitori/",
    tag: "品目ガイド",
    title: "【2026年最新】金ブレスレット・バングル買取相場ガイド — 喜平・テニスブレスの価格",
    description:
      "金ブレスレット・バングルの最新買取相場を純度別・重量別に掲載。喜平ブレスレットの買取価格、壊れていても売れる理由を解説。",
    tags: ["ブレスレット", "バングル", "喜平", "テニスブレス"],
  },
  {
