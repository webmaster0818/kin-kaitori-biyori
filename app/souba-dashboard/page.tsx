    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <h2 id="cite">データの引用・ウィジェット設置について</h2>
          <p>
            本ダッシュボードの価格・チャート・早見表は、<strong>出典（「金買取日和」＋本ページURL）の明記</strong>を条件に、メディア・ブログ・SNS等でご自由に引用いただけます。相場は毎日自動更新のため、最新値を反映しやすいよう<strong>無料の埋め込みウィジェット</strong>もご用意しています。
          </p>
          <ul>
            <li><strong>本日の金買取相場ウィジェット</strong>：あなたのサイトに1行のコードを貼るだけで、毎日自動更新される金相場（K24/K18等）を表示できます（無料・登録不要）。</li>
            <li>ブログ記事・資産運用/買取比較サイト・地域情報メディアなどでの設置に向いています。</li>
          </ul>
          <p>
            <Link href="/widget/">▶ 埋め込みウィジェットの設置方法・コードを見る</Link>　｜
            <Link href="/kin-kaitori-hakusho/">▶ 金買取相場の白書（引用用データ）を見る</Link>
          </p>
        </article>
      </div>
    </>
